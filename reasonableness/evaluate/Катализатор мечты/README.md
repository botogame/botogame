...
### Свобода от <a href="https://socionics.me/blogs/184-pasjans-medichi-hakerov-snovidenii.html">Пасьянса Медичи</a>
...
Через среду выходим на текущий месяц, при этом год всегда один (меняются только его версии = окончание декабря или смена вашей личной точки позиции). Но адекватно применять год в отношении себя, т.е. текущий месяц + 6 месяцев назад и 6 месяцев вперед. Например если сегодня август, то год это:
...
По факту готовности матрицы я дорисовывал восьмиконечную звезду как символ постоянства, внутри по центру рисовал глаз как символ надзора, а вокруг по три линии на четырёх внешних углах как символ безмятежности. Получалась бди-лка (Бери Добро Истины):
