...
<details>
<summary>Отзывчивость (пародия на Дискотеку аварию)</summary>
...
<details>
<summary>Изящество (пародия на Эдиту Пьеху)</summary>
...
<details>
<summary>Паханство (пародия на Муслима Магомаева)</summary>
...
<details>
<summary>Эстетика (пародия на Ва Банкъ)</summary>
...
<details>
<summary>Педантичность (пародия на Уматурман)</summary>
...
<details>
<summary>Фанатизм (пародия на Грибы)</summary>
...
<details>
<summary>Лаконичность (пародия на Лакосту)</summary>
...
| Педантичность  | подсматривание  | смятение  | результативность  | координация  |
| Фанатство  | впечатление  | отстаивание  | привлекательность  | одобрение  |
| Лаконичность  | искренность  | приобретение  | дружелюбие  | внимательность  |
...
| ------------- | ------------- | ------------- |
| Понедельник  | Солнце  | отзывчивость |
| Вторник  | Венера  | изящество |
| Среда  | Марс  | паханство |
| Четверг  | Луна  | эстетика |
| Пятница  | Сатурн  | педантичность |
| Суббота  | Юпитер  | фанатизм |
| Воскресенье  | Меркурий  | лаконичность |

Планеты пресыщают социум такими гильдиями:

| День недели  | Гильдия | Планета |
| ------------- | ------------- | ------------- |
| Понедельник  | Разведка | Солнце  | 
| Вторник  | Исследование | Венера  |
| Среда  | Автоматизация | Марс  |
| Четверг  | Оборона | Луна  |
| Пятница  | Политика | Сатурн  |
| Суббота  | Культура | Юпитер  |
| Воскресенье  | Торговля | Меркурий  |
...
Неделя сосредотачивается средой, где воскресенье → понедельник → вторник ( → среда) наполняют среду удачей, а суббота → пятница → четверг  → ( → среда) наполняют среду успехом.

выглядит это так:

| <br><br>воскресенье → понедельник → вторник → | {теущий месяц}<br>↑<br> → среда ← | <br><br> ← четверг ← пятница ← суббота |
| ------------- | ------------- | ------------- |
| удача для быстроты | сосредочение для удобства | успех для простоты | 
