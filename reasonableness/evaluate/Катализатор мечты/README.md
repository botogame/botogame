...
Через среду выходим на текущий месяц, при этом год всегда один (меняются только его версии = окончание декабря или смена вашей личной точки позиции): текущий месяц + 6 месяцев назад и 6 месяцев вперед. Например если сегодня август, то год это:
