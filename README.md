...
Я прорабатываю скилы родословной (родственники, близкие (муж-жена, дети), коллеги (у лялек они тоже есть) и друзья) и их корней для избавления от напрасной траты времени, за счёт форсирования методами симметриии.
