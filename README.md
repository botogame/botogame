...
За счёт форсирования методами симметриии здесь прорабатываются скилы родословной:

1. родственники
2. близкие (муж-жена, дети)
3. коллеги (у лялек они тоже есть)
4. друзья

и их корней для избавления от напрасной траты времени.
