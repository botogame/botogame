# Скил оптимальности: внушительность
## Проект "Конструктор yii2"
### Начало

После разоблачения yii2 я выявил 3 класса, которых достаточно для образования модуля.
...
На случай обновления yii или необходимого исключения сделаем обработчики (сборщики yii файлов) исходным кодом.

![](./Картинки/constructor_functions_2.png)

------------------

### Работа.

Для эффективной работы переведём акцент начала работы от конфига yii к контролёру.

![](./Картинки/constructor_add_command_2.png)
...
![](./Картинки/constructor_setup_3.png)
