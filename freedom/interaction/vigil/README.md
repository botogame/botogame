...
Цель ПМ не просто пройтись мантрами по решающим цепочкам событий, но и собрать матрицу. Читая мантру на каждом аркане (карте) вы подготавливаете к переходу (и в итоге переходите) через эту карту с новым собой. Как долго читать мантру - неизвестно, иногда сразу срабатывает за 1-5 минут чтения, иногда один раз прочёл, отвлекся на пол дня, и оно само сработало, иногда пробиваешь серьезное сопротивление. С каждым сбором матрицы у вас будет лучше опора от хаоса, и меньше затрат на переходы.

Правильные ограничения на составления желаний уже вложены в программу, помимо самого желания, вы должны опредить откуда будете черпать энергетику, с помощью своего наития (угадывания). Если вы следующим желанием захотели вновь от той же энергетики подчерпнуть, то программа не даст такой возможности, потому нужен баланс (вы нащупали быстрый старт и поднимите бучу, что никому пользы не принесет), лучшим вариантом будет прибегнуть к этому желанию через другое желание.
 
p.s. в таро ♤ - мечи, ♡ - кубки , ♢ - жезлы, ♧ - пентакли. Номиналы и картинки арканов соотвествуют, только значение арканов будет как описано в ключах от Бдилки.
p.s. андроид приложение нужно вручную скачать на мобильный и запустив установить.
</details>
