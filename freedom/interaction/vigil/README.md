...
1. выбераете свой пол
2. если в первый раз пасьянс то выставляете последней картой: 8
3. пишите своё желание
4. подбираете под желание сферу влияния (там где треш по ощущениям)
5. подбираете под сферу влияния тип (где больше недостатка по ощущениям)
6. если хотите создать свой рай, то выбирайте Нужда, если доказать (наказать) кому то - внедрение
