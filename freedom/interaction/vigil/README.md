...
Как пользоваться программой:
    ...
    3. пишите своё желание
    4. подбираете под желание сферу влияния (там где трэш по ощущениям)
...
Устройство которое было перед ним называли бдилкой. И это был не просто прибор, а нечто живое, соединённое с разумом людей, чьи мечты и желания о свободе от мира, правил и ограничений давали ему силу. Но никто до конца не понимал, как устройство работает, и уж тем более, к чему это может привести.
...
Первый понял. Мечты, которые создавала бдилка, были отражением их хозяев. Люди создавали тюрьмы не потому, что желали этого, а потому что не знали, как управлять своими собственными страхами и желаниями. В поисках свободы они теряли себя.
...
Через среду выходим на текущий месяц, при этом год всегда один (меняются только его версии = окончание декабря или смена вашей личной точки позиции). Но адекватно применять год (который начинается с 8 марта и заканчивается 7 мартом) в отношении себя, т.е. текущий месяц + 6 месяцев назад и 6 месяцев вперед. 
