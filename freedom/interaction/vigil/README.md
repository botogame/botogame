...
Разработана программа в виде <a href="./выбор_желания.html">html файла</a>, <a href="https://botogame.github.io/vigil/">онлайн программы</a> и <a href="https://botogame.github.io/vigil/ПМ_Бдилка.apk">андроид приложение</a>. 

<details>
<summary><ins>Инструкция к программе</ins></summary>

Работать с программой можно в одиночку. Выкладка изменения реальности происходит на 70%, далее нужно дополняться квантовыми технологиями.
 
Цель ПМ (пасьянс медичи) Бдилки не просто пройтись мантрами по решающим цепочкам событий, но и собрать расклады в квадратуру (по клику на карты в программе открывается окно статуса сборки цепочек событий в квадратуру 5x5, 7x7 и т.д.). Читая мантру на каждом аркане (карте) вы подготавливаете к переходу (и в итоге переходите) через эту карту с новым собой. Как долго читать мантру - неизвестно, иногда сразу срабатывает за 1-5 минут чтения, иногда один раз прочёл, отвлекся на пол дня, и оно само сработало, иногда пробиваешь серьезное сопротивление. Итоговыми ощущениями (ожидания) после перехода через арканы будут не те, к которым вы возможно ранее привыкли, но каждым сбором раскладов в квадратуры у вас будет лучше опора для понимания и надежная защита от хаоса, и меньше затрат на переходы.

Правильные ограничения на составления мечты (сфера + направление влияния) уже вложены в программу. Если вы следующей мечтой захотели вновь от той же энергетики подчерпнуть (направления было использовано предыдущей мечтой), то программа не даст такой возможности, потому что нужен баланс (вы нащупали быстрый старт и поднимите бучу, что никому пользы не принесет), и лучшим вариантом будет прибегнуть к этой мечте после выполнения другого (какой нибудь второсортной мечты).

Как пользоваться программой:

    1. выбираете свой пол
    2. если в первый раз пасьянс то выставляете последней картой: 8
    3. пишите свою мечту
    4. подбираете под мечту сферу влияния (там где трэш по ощущениям)
    5. подбираете под сферу влияния направление (где больше недостатка по ощущениям)
    6. если хотите создать свой рай, то выбирайте тип Нужда, если доказать (наказать) кому то - внедрение

На версии 2 добавлены авто-расклады на отработки долгов, что поможет фиксануть то, что не учли.
 
p.s. младшие арканы имеют те же цифры что и ключи карт, только масти соотнесите: ♤ - мечи, ♡ - кубки , ♢ - жезлы, ♧ - пентакли. Старших арканов должно быть 28 (пажи должны были быть в старших арканах + добрать ещё 2 неизвестные карты). Каждый старший аркан представляет собой масть дня недели (добавлено в 3-ю версию).

p.s. <a href="https://botogame.github.io/vigil/%D0%9F%D0%9C_%D0%91%D0%B4%D0%B8%D0%BB%D0%BA%D0%B0.apk">андроид приложение</a> нужно скачать на мобильный телефон с андроидом и, запустив скачанный файл, установить. Для обновления до новой версии тоже самое, скачать - запустить, и на предложение обновить - подтвердить. Выдается как демо версия (по причине текущего моего конструктора, который трудно пока купить), нужно обновляться через 30 дней (когда срок пройдет, попросите - актуализирую, обновите программу, текущий расклад останется прежним).

p.s. браузеры на мобиле iOS пока не могут работать с бдилкой. 
</details>

<a href="https://www.youtube.com/watch?v=YieSnFlA1Dw">Видосик вводная</a>

Телеграм для связи: <a href="https://t.me/+pray5RL3J3UyYTQy">t.me/pm_bdilka</a>

<hr>

### Пещера

Пещера была пуста, за исключением двух предметов — стола по центру комнаты и странного устройства на нём, которое пульсировало мягким светом, едва освещая стены. Туда вошёл мужчина, назовём его первым. Он посмотрел на устройство, нервно скрестив руки на груди. Ему предстояло сделать выбор, который изменит судьбы многих, хотя пока он и сам не осознавал, насколько велико его влияние.

Устройство которое было перед ним называли бдилкой. И это был не просто прибор, а нечто живое, соединённое с разумом людей, чьи молитвы и желания о свободе от мира, правил и ограничений давали ему силу. Но никто до конца не понимал, как устройство работает, и уж тем более, к чему это может привести.

В комнату вошла женщина, её лицо было скрыто тенью капюшона. Она медленно подошла к устройству и, не говоря ни слова, взглянула на мерцающий алмаз.

— Ты знаешь, что это не случайно? — спросила она тихо. — Они сами сделали свой выбор.

— Выбор? — горько рассмеялся первый. — Разве это был их выбор? Они просто не знали, что происходит за границами их сознания. Бдилка взяла всё, что у них было, и изменил их миры так, что они уже не могут вернуться.
...
С этими словами женщина в капюшоне протянула руку к устройству и набрала цепочку событий из пасьянса Медичи. Комната заполнилась резким звуком, и алмаз мигнул. Внезапно устройство перестало пульсировать, и свет в комнате угас.
...
Оказался список удивительных мечтаний
```
...
| Лаконичность  | искренность  | вразумление  | дружелюбие  | внимательность  |
...
При этом, ♡ + ♤ = 🍒 очарование, ♢ + ♧ = 🌈 преображение.
...
Здесь Т и 2-ка смежные уровни, которые запитаны друг на друга в виде марта, как причина реальной смены старого года на новый: **7-го марта заканчивается, 8-го марта начинается**. 
...
Переправы будут образовывать часть цепочки событий пасьянса Медичи, только ваша часть будет работать на вас, за счёт бронирования (вашей мечтой).
...
— Ты сам позволил ей взять контроль. Ты забыл, что изначально этот мир был твоим. Молитвы и желания — это только инструменты. Свет здесь всегда был внутри тебя, ты просто перестал его видеть.
...
Перед ним снова появилось устройство, бдилка. Её алмаз был теперь тусклым, как будто больше не питался чужими мечтами. Женщина в капюшоне стояла рядом, на этот раз её лицо было видно: спокойное, с лёгкой улыбкой, как будто она всегда знала, что всё закончится именно так.
...
Первый понял. Мечты, которые создавала бдилка, были отражением их хозяев. Люди создавали тюрьмы не потому, что мечтали об этом, а потому что не знали, как управлять своими собственными страхами. В поисках свободы они теряли себя.
...
Ключи (в нашем случае будем применять ключи, а не выполнять действия) к уровням изъятия обогащения такие:

| Номинал | ♡ | ♤ | ♧ | ♢ |
| --- | --- | --- | --- | --- |
| `Т` | затаить | забронировать | укомплектовать | подобрать |
...
| `6` | разобрать | настоять | дополнить | обеспечить |
...
```
Я {желаю/молю} от своей бдилки
{какого: такого то режима обогащения по масти}
{чего: чьего то ключа к уровню обогащения}
чтобы
{что: что то, о чем я мечтаю}
```

- для женщины: молю
- для мужчины: желаю

Пример для 4♢ (лаконичность):

<b>Я желаю от своей бдилки внимательного обрадования, чтобы у меня было много денег.</b>

Но по началу лучше проработать себя изначальной мантрой "я желаю всем счастья" если мужчина (можно вместе с О. Торсуновым) и "я молю всем кайфа" если женщина (можно альтернативную мантру Хоопонопоно). Мантру нужно проговаривать (или про себя) до состояния эмпатии, когда "увидите" чёткий образ действий без сопротивления. В дальнейшем этот образ (проекция) реализуется сама собой посредством вас или кого то, если конечно никто не воспрепятствует, но это вы заметите.
...
| отзывчивость  | таблетки  | +  | переписка  |
...
| Четверг  | педантичность  | оригинальности |
...
Планеты пресыщают социум такими специализациями:

| День недели  | Специализация | Планета |
| ------------- | ------------- | ------------- |
...
По дате своего рождения вы можете понять для какой специализации вы родились в своём городе (или от какого Бога-Богини вы можете всегда получить любую помощь за так).

Неделя сосредотачивается средой для удобства, где воскресенье → понедельник → вторник ( → среда) наполняют среду удачей для наглядности, а суббота → пятница → четверг  → ( → среда) наполняют среду везением для простоты.

Выглядит это так:

| удача для наглядности | сосредочение для удобства | везение для простоты |
| ------------- | :---: | ------------- |
| <br><br>воскресенье → понедельник → вторник → | {месяц}<br>↑<br> → среда ← | <br><br> ← четверг ← пятница ← суббота | 

Через среду выходим на текущий месяц, при этом год всегда один (меняются только его версии = окончание декабря или смена вашей личной точки позиции). Но адекватно применять год (который начинается с 8 марта и заканчивается 7 мартом) в отношении себя. 
...
| ------------- | :---: | ------------- |
| март → апр → май → июн → июл → | → август ← | ← сен ← окт ← ноя ← дек ← янв ← фев ← март | 
...
Домашнее идёт как основа мироздания (все семь специализаций работают исправно):
...
По факту готовности матрицы можно дорисовывать восьмиконечную звезду как символ постоянства, внутри по центру дорисовать глаз как символ надзора, а вокруг по три линии на четырёх внешних углах как символ безмятежности. 

<img src="./Картинки/13.png" width="100">

Её называли БДИ-лкой (Бери-Добро-Истины). Как я когда то словил информацию - это схема устройства преодолевающее гравитацию.
