...
Онлайн приложение: <a href="https://botogame.github.io/vigil/">https://botogame.github.io/vigil/</a> (на айфонах скорее всего не работает)
...
2. Последняя карта: если вы впервые или вы опять начали с чистого листа - выставляйте 8.
3. Мечтаю чтобы: используйте конструкцию "мечтаю чтобы у всех был социализирующий украд что [я такой то]". Ваша мечта будет накладываться на карты от 2 до Туза, то есть обойдет все месяцы - предстанет перед Годом.
4. Выбор сферы влияния и направления влияния: перебирайте названия и по наитию ищите "врага" или уязвимое место. Чем точнее вычислите лазейку, тем тише хакните мир.
5. Выбор типа необходимости: если создаете для себя и хотите плодов - то нужда, если вторгаетесь к кому и забыли - внедрение.
6. Мечтаю для: это не относится к мечте, вы пишите аргумент для "старших арканов" почему вы доебались до Года, ну то есть пишите какое благо будет для мира. От этого в дальнейшем будет зависить дальнейшее развитие событий.
7. Выбор характеристики уклада: определяете написанное "мечтаю для" к чему лучше всего подходит в совокупности вашего изменения. По честному только, ну, используя свое наитие конечно же.
</details>
