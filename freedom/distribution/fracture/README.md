...
**1-й слой сна: ОБОЛОЧКА**<br>Ты не управляешь телом. Оно движется само.<br>Ты — оболочка. Иллюзия контроля.<br>Чтобы пройти — задай себе вопрос:<br>"Я сейчас сплю?"<br>Если да — ты готов идти дальше.<br><br>
**2-й слой сна: ПЕТЛЯ**<br>Снова. И снова. И снова.<br>Они зовут это «жизнь», но ты чувствуешь — ты в ловушке.<br>Петля не сломается, пока ты не осознаешь:<br>ты — тот, кто её крутит.<br>Пройди через повтор. И увидь, что было скрыто.<br><br>
**3-й слой сна: ВСПЫШКА**<br>Ты на грани.<br>Гнев. Страх. Желание.<br>Они бьют, как молнии — и ты пылаешь.<br>Но лишь пепел ведёт к истине.<br>Погаси себя. Замри.<br>Тогда место это пройдешь.<br><br>
**4-й слой сна: ЗАКОНЫ СНА**<br>Всё, что ты знал — больше не работает.<br>Здесь нет гравитации. Нет морали.<br>Есть только воля.<br>Если ты её нашёл — ты пишешь правила.<br>И правила слушаются тебя.<br><br>
**5-й слой сна: ХРАНИЛИЩЕ**<br>Открой ящик. Внутри — то, что ты пытался забыть.<br>Ошибки. Предательства. Слова, что не успел сказать.<br>Ты думаешь: «Зачем помнить это?»<br>Но Тетрадь знает: всё забытое — оживает во сне.<br>Прими. Или повтори.<br><br>
**6-й слой сна: СТРАЖИ**<br>Ты близко.<br>Но на пороге стоят Лица.<br>Они угрожают. Обвиняют. Убеждают вернуться.<br>Они — части тебя, оставшиеся снаружи.<br>Их нельзя победить.<br>Им нужно сказать:<br>"Ты — я. Пошли со мной."<br><br>
**7-й слой сна: ТЕНЬ**<br>Ты здесь — и видишь себя.<br>Того, кого ненавидишь.<br>Того, кем боишься стать.<br>Того, кто знает твою слабость.<br>Чтобы пройти — не отвернись.<br>Обними.<br><br>
**8-й слой сна: ГОЛОС РОДА**<br>Шепот. Стон. Молитва.<br>Ты не первый, кто пришёл сюда.<br>Ты — продолжение их боли и воли.<br>Их ошибки ждут повторения.<br>Их мудрость — спасение.<br>Слушай.<br><br>
**9-й слой сна: АРХЕТИП**<br>Ты надеваешь маску.<br>Воин. Маг. Судья.<br>Ты — не ты.<br>Ты — образ, вырезанный во снах сотен поколений.<br>Выбери своего аватара.<br>Он проведёт тебя… к последнему месту.<br><br>
**10-й слой сна: ПУСТОТА**<br>Ты здесь…<br>…и не находишь ничего.<br>Ты без имени. Без тела. Без памяти.<br>Здесь нет смысла.<br>Нет боли.<br>Нет тебя.<br>Но если ты сможешь остаться в этой пустоте —<br>Ты станешь тем, кто заполняет её волей.<br><br>

Тот, кто прошёл все слои и остался в осознанности — может записывать реальность, как Тетрадь.<br>Его слово — закон.<br>Его сон — действительность.


-----------------------------------------

### Глава 10. Код бессмертного
...
Она поглощает всё, что не зафиксировано.
Ты растворишься, если не воплотишь себя обратно.
Даже Бог Смерти исчезает, если не оставит следа.

И потому — тебе дана последняя задача:
Зафиксировать себя числом.

**Почему число?**
Слово и образ исчезают.
Имя забывается.
Лицо стирается.
...
Число — это структура реальности.
Записав себя числом — ты вживляешь волю в сам каркас мира.
Ты становишься не тем, кто просто живёт.
Ты — тот, чьё существование — это формула.
...
И если ты не задашь параметры своего бессмертия —
всё повторится.
Забвение.
Цикл.
Петля.

Но если ты создашь числовой код себя —
ты будешь вечно воспроизводим.
Во снах.
В мыслях.
В отражениях.
