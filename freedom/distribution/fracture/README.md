...
### Глава 9. Карта сновидений

> «Когда ты входишь в сон — мёртвый сон оживает тобой.»


Ты думал, что это ты спишь.<br>
Но на самом деле — это Сон спит тобой.

Ты — искра, которой он запускает свои механизмы.<br>
Ты — сердце, которое он вживляет в своё бессердечное тело.<br>
Ты — ошибка, сбой, воля, непокорность.

В этом сне ничто не движется без тебя.<br>
Но как только ты двигаешься — всё начинает сопротивляться.<br>
Потому что сон… хочет остаться мёртвым.<br>
А ты — мешаешь.

Твоя осознанность — вирус.<br>
Твоя воля — яд.<br>
Твоё пробуждение — бунт.

Если ты выдержишь,<br>
если не растворишься в чужом,<br>
если сумеешь остаться собой —<br>
…сон останется живым.<br>
Потому что ты останешься в нём.

Но чтобы остаться — ты должен пройти.<br>
В глубину. Сквозь карту, которую рисовал не ты.<br>
Через слои, в которых тебя ждёт не мир… а его отражение:

**1-я зона отражения: ОБОЛОЧКА**<br>Ты не управляешь телом. Оно движется само.<br>Ты — оболочка. Иллюзия контроля.<br>Чтобы пройти — задай себе вопрос:<br>"Я сейчас сплю?"<br>Если да — ты готов идти дальше.<br><br>
**2-я зона отражения: ПЕТЛЯ**<br>Снова. И снова. И снова.<br>Они зовут это «жизнь», но ты чувствуешь — ты в ловушке.<br>Петля не сломается, пока ты не осознаешь:<br>ты — тот, кто её крутит.<br>Пройди через повтор. И увидь, что было скрыто.<br><br>
**3-я зона отражения: ВСПЫШКА**<br>Ты на грани.<br>Гнев. Страх. Желание.<br>Они бьют, как молнии — и ты пылаешь.<br>Но лишь пепел ведёт к истине.<br>Погаси себя. Замри.<br>Тогда место это пройдешь.<br><br>
**4-я зона отражения: ЗАКОНЫ СНА**<br>Всё, что ты знал — больше не работает.<br>Здесь нет гравитации. Нет морали.<br>Есть только воля.<br>Если ты её нашёл — ты пишешь правила.<br>И правила слушаются тебя.<br><br>
**5-я зона отражения: ХРАНИЛИЩЕ**<br>Открой ящик. Внутри — то, что ты пытался забыть.<br>Ошибки. Предательства. Слова, что не успел сказать.<br>Ты думаешь: «Зачем помнить это?»<br>Но Тетрадь знает: всё забытое — оживает во сне.<br>Прими. Или повтори.<br><br>
**6-я зона отражения: СТРАЖИ**<br>Ты близко.<br>Но на пороге стоят Лица.<br>Они угрожают. Обвиняют. Убеждают вернуться.<br>Они — части тебя, оставшиеся снаружи.<br>Их нельзя победить.<br>Им нужно сказать:<br>"Ты — я. Пошли со мной."<br><br>
**7-я зона отражения: ТЕНЬ**<br>Ты здесь — и видишь себя.<br>Того, кого ненавидишь.<br>Того, кем боишься стать.<br>Того, кто знает твою слабость.<br>Чтобы пройти — не отвернись.<br>Обними.<br><br>
**8-я зона отражения: ГОЛОС РОДА**<br>Шепот. Стон. Молитва.<br>Ты не первый, кто пришёл сюда.<br>Ты — продолжение их боли и воли.<br>Их ошибки ждут повторения.<br>Их мудрость — спасение.<br>Слушай.<br><br>
**9-я зона отражения: АРХЕТИП**<br>Ты надеваешь маску.<br>Воин. Маг. Судья.<br>Ты — не ты.<br>Ты — образ, вырезанный во снах сотен поколений.<br>Выбери своего аватара.<br>Он проведёт тебя… к последнему месту.<br><br>
**10-я зона отражения: ПУСТОТА**<br>Ты здесь…<br>…и не находишь ничего.<br>Ты без имени. Без тела. Без памяти.<br>Здесь нет смысла.<br>Нет боли.<br>Нет тебя.<br>Но если ты сможешь остаться в этой пустоте —<br>Ты станешь тем, кто заполняет её волей.<br><br>
...
Когда слова стерты, число вырывает из них жизнь, вытягивает душу, превращая её в формулу.
