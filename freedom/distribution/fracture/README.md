...
Ты стучишь — и дверь открывается сама.
Ты не управляешь телом. Оно движется само.
Ты — оболочка. Иллюзия контроля.
Чтобы пройти — задай себе вопрос:
"Я сейчас сплю?"
Если да — ты готов войти.


2-я Дверь: ПЕТЛЯ

Снова. И снова. И снова.
Они зовут это «жизнь», но ты чувствуешь — ты в ловушке.
Петля не сломается, пока ты не осознаешь:
ты — тот, кто её крутит.
Пройди через повтор. И увидь, что было скрыто.
...
Ты на грани.
Гнев. Страх. Желание.
Они бьют, как молнии — и ты пылаешь.
Но лишь пепел ведёт к истине.
Погаси себя. Замри.
Тогда дверь откроется.


4-я Дверь: ЗАКОНЫ СНА

Всё, что ты знал — больше не работает.
Здесь нет гравитации. Нет морали.
Есть только воля.
Если ты её нашёл — ты пишешь правила.
И правила слушаются тебя.


5-я Дверь: ХРАНИЛИЩЕ

Открой ящик. Внутри — то, что ты пытался забыть.
Ошибки. Предательства. Слова, что не успел сказать.
Ты думаешь: «Зачем помнить это?»
Но Тетрадь знает: всё забытое — оживает во сне.
Прими. Или повтори.
...
Ты близко.
Но на пороге стоят Лица.
Они угрожают. Обвиняют. Убеждают вернуться.
Они — части тебя, оставшиеся снаружи.
Их нельзя победить.
Им нужно сказать:
"Ты — я. Пошли со мной."
...
Ты входишь — и видишь себя.
Того, кого ненавидишь.
Того, кем боишься стать.
Того, кто знает твою слабость.
Чтобы пройти — не отвернись.
Обними.


8-я Дверь: ГОЛОС РОДА

Шепот. Стон. Молитва.
Ты не первый, кто пришёл сюда.
Ты — продолжение их боли и воли.
Их ошибки ждут повторения.
Их мудрость — спасение.
Слушай.
...
Воин. Маг. Судья.
Ты — не ты.
Ты — образ, вырезанный во снах сотен поколений.
Выбери своего аватара.
Он проведёт тебя… к последней двери.


10-я Дверь: ПУСТОТА

Ты входишь…
…и не находишь ничего.
Ты без имени. Без тела. Без памяти.
Здесь нет смысла.
Нет боли.
Нет тебя.
Но если ты сможешь остаться в этой пустоте —
Ты станешь тем, кто заполняет её волей.

Дополнительная дверь:
Тот, кто прошёл все двери и остался в осознанности — может записывать реальность, как Тетрадь.
Его слово — закон.
Его сон — действительность.
