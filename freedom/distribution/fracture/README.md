...
```
"Пока тело спит — разум бодрствует. Но разве это не уловка самого тела?" — L (неклассифицированное досье)
```
...
```
"Когда я смотрю во сне на небо и не вижу звёзд — я знаю, что это небо из лжи." — Raito, запись №28
```
...
```
"Рука — единственное оружие во сне, которое ты носишь с собой. Если ты не контролируешь руку — ты не бог сновидения, ты жертва." — Ryuk, комментарий к полю L-45
```
...
```
"Я стоял на границе мира и сделал шаг. Мир уступил." — Мисора Наоми, фрагмент сна, архив SPK
```
...
```
"Останови дыхание — и увидишь, как сон начнёт рушиться. Увеличь ритм — и станешь создателем." — L, протокол наблюдения сна
```
...
```
"Каждая часть тела — это слово. Вместе они составляют фразу: Я есмь." — из черновика Кира
```
...
```
"Я сновидец. Я — тело, помнящее себя в тишине." — неизвестный, запись на спичечном коробке
```
