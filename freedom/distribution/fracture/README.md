...
function getAncientRomanMonth() {
  ...
  const ranges = [
    { name: "1-м узле: ЗЕРКАЛО ТЕЛА", desc: "Ты внутри сна — но не управляешь. Все движения автоматичны. Всё — как будто не твое.",     number: 1, from: 1,   to: 31 },
    { name: "2-м узле: МЕХАНИЗМ ВРЕМЕНИ", desc: "Ты снова в том же месте. Повтор. День сурка. Всё предсказуемо — и бесконечно.",    number: 2, from: 32,  to: 61 },
    { name: "3-м узле: ЭМОЦИОНАЛЬНАЯ ГРОЗА",desc: "Напряжение нарастает.",       number: 3, from: 62,  to: 92 },
    { name: "4-м узле: МИР БЕЗ ЗАКОНОВ", desc: "Абсурд, сломанные законы, но всё — логично по-своему.",     number: 4, from: 93,  to: 122 },
    { name: "5-м узле: ЗАПРЕТНАЯ ПАМЯТЬ",desc: "Спертый воздух, пыль в солнечном луче, напряжённая тишина. Всё внутри будто ждало, что ты вернёшься — хотя ты обещал себе, что не вернёшься никогда.",   number: 5, from: 123, to: 153 },
    { name: "6-м узле: ПОРОГОВЫЕ ЛИЦА", desc: "Вежливая ловушка. Всё кажется 'правильным': мягкие голоса, разумные аргументы, знакомые лица. Но внутри — нарастающий холод.",   number: 6, from: 154, to: 183 },
    { name: "7-м узле: ОБРАТНАЯ СТОРОНА", desc: "Тревожная встреча. Кто-то похож на тебя, но искажён.",  number: 7, from: 184, to: 213 },
    { name: "8-м узле: ШЕПОТ ПРЕДКОВ",desc: "Приглушённо, по древнему, сакрально.",     number: 8, from: 214, to: 244 },
    { name: "9-м узле: ОБРАЗ ИЗ СНА",  desc: "Символично, почти по мифическому.",  number: 9, from: 245, to: 274 },
    { name: "10-м узле: БЕЛАЯ ПУСТОТА", desc: "Белый шум, ничто, спокойствие, почти смерть.",   number: 10,from: 275, to: 305 }
  ];
  ...
  return found
    ? `Перелом на ${found.name}.<br><br>${found.desc}`
