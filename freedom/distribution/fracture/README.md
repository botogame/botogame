...
- Прошлое и будущее взаимосвязаны, потому что оба зависят от восприятия — меняя отношение к прошлому, человек меняет себя в настоящем, а значит и своё будущее.
