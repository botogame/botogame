...
Предыдущий вариант как привелегии не юзабельны, по причине что модульность может не прижиться: нашим восприятием мы не запомним нагромождение сотни модулей на одной линии. А реактивность нужна. Поэтому контейнер будет задавать предпочтения (приманка), которые будет вмещать. Корень программы это так же контейнер. Нужно выстроить предпочтения так, чтобы это были трамплинами.
