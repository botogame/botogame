...
1. в атрибут можно добавить рефлекс, это ещё было в версии 1, но в версии 2 запретим автозапуск схемы внутри тэгов и добавим "запуск" когда будет какой то контакт (изменение) с атрибутом (уже после авто-запуска).
