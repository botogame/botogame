...
На третьей снизу презентации мы можем работать с кодом по задачам, и например если нужно внести срочный баг-фикс, мы скрываем изменения с определенной меткой, вносим баг-фикс, и актуализируем предыдущую работу.
