...
В продолжении <a href="../Прототипы/Образование%20индивидуальности/README.md">образования индивидуальности</a> я создал катализатор талантов вдохновлённой Временем: <a href="./Катализатор талантов_v12.zip">12 версия</a> (без видео-файлов - нужно вручную добавлять).
